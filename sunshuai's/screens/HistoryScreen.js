        ...
        renderItem={({item}) => (
          <View style={styles.orderInformation}>
            ...
            <View style={styles.icon_inline}>
              <Ionicons name="local-shipping" size={22} color={'green'} />
